...
struct node
{
    ...
    static node_t* make_inner_n(count_t n)
    {
        ...
        // BUG: Possible if there is any caller that does not modify these values?
        // NVM_PERSIST_NOW(p, n_size);
        return p;
    }
    ...
    static node_t* make_inner_n(count_t n, values_t* values)
    {
        ...
        if (values) {
            ...
            // Flushed by callers
            // NVM_PERSIST_NOW(&(p->impl.d.data.inner.values), sizeof(values_t*));
    ...
    static node_t* make_inner_n(count_t n, count_t nv)
    {
        ...
        if (nv) {
            try {
                ...
                // NVM_PERSIST_NOW(p->impl.d.data.inner.values, sizeof_values_n(nv));
            } catch (...) {
                                      ...
                                      count_t offset, node_t* child)
    {
        ...
        // Nodemap, datamap, values(from make_inner_n) and children are one struct.
        // We flush them together.
        // NVM_PERSIST_NOW(&(dst->impl.d.data.inner), immer_offsetof(inner_t, values));
        ...
        NVM_PERSIST_NOW(((char*)dstp)+64, (char*)(dstp+n-1) - ((char*)dstp+64));
        return dst;
    }
                                            ...
                                            count_t offset, T v)
    {
        ...
        try {
            ...
            try {
                ...
                // together.
                NVM_PERSIST_NOW(dst->values(), (char*)(dst->values()+nv)-(char*)dst->values());
            } catch (...) {
        ...
        node_t* src, bitmap_t bit, count_t voffset, node_t* node)
    {
            ...
            try {
                ...
                try {
                    std::uninitialized_copy(
                            ...
                            dst->values() + voffset);
                    NOTE("copy_inner_replaced_merged: dst->values()+voffset:%p voffset:%lu nv:%lu\n", dst->values()+voffset, voffset, nv);
                    // Both copies flushed together.
                    NVM_PERSIST_NOW(dst->values(), (char*)(src->values()+nv-1)-(char*)src->values());
                } catch (...) {
        ...
        // dst->children simply points to data.inner.buffer so we flush
        // all of inner together.
        NVM_PERSIST_NOW(&(dst->impl.d.data.inner), (char*)(dst->children()+noffset)-(char*)(dst->children()));
        return dst;
    }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    NOTE("copy_inner_replace_inline: dst->values+voffset+1:%p\n", dst->values()+voffset+1);
                    // Both copies flushed together
                    NVM_PERSIST_NOW(dst->values(), (char*)(src->values()+nv)-(char*)src->values());
                } catch (...) {
            ...
            try {
                ...
                try {
                    std::uninitialized_copy(
                        ...
                        dst->values() + offset + 1);
                    NOTE("copy_inner_insert_value: dst->values()+offset+1:%p nv:%lu\n", dst->values()+offset+1, nv);
    ...
    node_t* inc()
    {
        ...
        std::cout << "Size of collision (0):" << sizeof_collision_n(0) << std::endl; 
        std::cout << "Size of collision (1):" << sizeof_collision_n(1) << std::endl; 
        std::cout << "Size of collision (2):" << sizeof_collision_n(2) << std::endl; 
        std::cout << "Offset of impl_data_t:" << immer_offsetof(impl_t, d) << std::endl;
        std::cout << "Size of impl_data_t:" << sizeof(impl_data_t) << std::endl;
        std::cout << "Size of data_t:" << sizeof(data_t) << std::endl;
        std::cout << "Offset of data:" << immer_offsetof(impl_data_t, data) << std::endl;
        std::cout << "Node:" << (void*) this << ", refs:" << (void*) &(refs(this)) << " data:" << (void*) &(impl.d) << std::endl;
        */
        return this;
    }
