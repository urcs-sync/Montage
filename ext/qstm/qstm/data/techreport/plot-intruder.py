...
#plt.plot(qstm128_x, qstm128_thpt, label='QSTM-128', linestyle=linestyles[1], linewidth=2, marker=markerstyles[1], markersize=8)
#plt.plot(mnem_x, mnem_thpt, label='Mnemosyne', linestyle=linestyles[2], linewidth=2, marker=markerstyles[2], markersize=10)
plt.plot(qstm2k_x, qstm2k_thpt, label='QSTM-2k', linestyle=linestyles[0], linewidth=2, marker=markerstyles[0], markersize=10)
...
plt.xlim(0,74)
plt.ylim(0,4200000/scale)

plt.xticks((1, 4, 8, 16, 24, 32, 40, 48, 64, 72))

#plt.title("STAMP Intruder")
